...
- (id)initWithStyle:(STXCommentCellStyle)style comment:(NSObject<InstaComment>*)comment totalComments:(NSInteger)totalComments reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        if (style == STXCommentCellStyleShowAllComments) {
            ...
            NSObject<InstaUser>* commenter = [comment from];
...
- (instancetype)initWithStyle:(STXCommentCellStyle)style comment:(NSObject<InstaComment>*)comment reuseIdentifier:(NSString *)reuseIdentifier
{
...
- (void)setComment:(NSObject<InstaComment>*)comment
{
    if (_comment != comment) {
        _comment = comment;
