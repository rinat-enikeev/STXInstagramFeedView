...
- (id)initWithCaption:(NSObject<InstaCaption> *)caption reuseIdentifier:(NSString *)reuseIdentifier
{
    self = [super initWithStyle:UITableViewCellStyleDefault reuseIdentifier:reuseIdentifier];
    if (self) {
        NSString *text = caption.text;
...
- (void)setCaption:(NSObject<InstaCaption> *)caption
{
    if (_caption != caption) {
        _caption = caption;
