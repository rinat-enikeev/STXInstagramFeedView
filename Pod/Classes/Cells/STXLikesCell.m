...
- (instancetype)initWithStyle:(STXLikesCellStyle)style likesCount:(NSInteger *)likesCount likers:(NSOrderedSet<NSObject<InstaUser> *> *)likers reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        if (style == STXLikesCellStyleLikesCount) {
            _likesLabel = [self likesLabelForCount:likesCount];
        } else {
...
- (void)setLikersLabel:(TTTAttributedLabel *)likersLabel likers:(NSOrderedSet<NSObject<InstaUser> *> *)likers
{
    ...
    for (NSObject<InstaUser> * liker in likers) {
        NSString *likerName = liker.username;
...
- (TTTAttributedLabel *)likersLabelForLikers:(NSOrderedSet<NSObject<InstaUser> *> *)likers
{
